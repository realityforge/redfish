...
class Redfish::Tasks::TestDomain < Redfish::Tasks::BaseTaskTest
  ...
  def test_create_with_most_common_options
    ...
    executor.expects(:exec).with(equals(t.context),
                                 equals('create-domain'),
                                 equals(%W(--checkports=false --savelogin=false --savemasterpassword=false --domaindir #{test_domain_dir} --domainproperties domain.adminPort=4848 domain1)),
                                 equals({})).
      returns('')
