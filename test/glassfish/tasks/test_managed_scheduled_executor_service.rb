...
class Redfish::Tasks::Glassfish::TestManagedScheduledExecutorService < Redfish::Tasks::Glassfish::BaseTaskTest
  def test_interpret_create
    data = {'managed_scheduled_executor_services' => resource_parameters_as_tree}
  ...
  def test_to_s
    ...
    assert_equal t.to_s, 'managed_scheduled_executor_service[MyScheduledExecutorService]'
  end
  ...
  def test_interpret_create_and_delete
    data = {'managed_scheduled_executor_services' => resource_parameters_as_tree(:managed => true)}
  ...
  def property_prefix
    "#{raw_property_prefix}MyScheduledExecutorService."
  end
