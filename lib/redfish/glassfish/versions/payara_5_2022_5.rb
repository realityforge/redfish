...
module Redfish
  module Versions
    class Payara5_2022_5 < BaseVersion

      def initialize
        super('492', :payara, '5.2022.5')
      end
      ...
      def default_jvm_defines
        {
          ...
          # '[17|]--add-opens=java.desktop/java.beans' => 'ALL-UNNAMED'
          # '[17|]--add-exports=jdk.naming.dns/com.sun.jndi.dns' => 'ALL-UNNAMED'
        }
      end
...
Redfish::VersionManager.register_version(Redfish::Versions::Payara5_2022_5.new)
